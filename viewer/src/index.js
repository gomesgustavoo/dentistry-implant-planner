...
/* `parseWebMesh` moved to `./mesh.js`: the model picker parses the same format now, and
 * a second copy of a binary parser is a second place for an off-by-sixteen to hide. */
